...
module.exports = function(clusters, coap) {
  if (!clusters.OnOffCluster) {
    console.log('Expected OnOffCluster on', clusters);
  }

  clusters.OnOffCluster.prototype.bind = function(attrs, callback) {
  ...
  clusters.OnOffCluster.prototype.listen = function(server, callback) {
    var meta = this.meta;
