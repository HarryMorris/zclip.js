...
module.exports = function(target, coap) {
  if (!target.clusters.OnOffCluster) {
    console.log('Expected OnOffCluster on', target);
  }

  target.clusters.OnOffCluster.prototype.bind = function(attrs, callback) {
  ...
  target.clusters.OnOffCluster.prototype.listen = function(server, callback) {
    var meta = this.meta;
